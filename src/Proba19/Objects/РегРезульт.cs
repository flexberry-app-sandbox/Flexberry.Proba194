...
namespace IIS.Proba19
{
    ...
    public class РегРезульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba19.Организация fОрганизация;
        
        private IIS.Proba19.DetailArrayOfТЧРегРезульт fТЧРегРезульт;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.Proba19.Организация Организация
        {
            get
            {
                ...
                IIS.Proba19.Организация result = this.fОрганизация;
        ...
        public virtual IIS.Proba19.DetailArrayOfТЧРегРезульт ТЧРегРезульт
        {
            get
            {
                ...
                {
                    this.fТЧРегРезульт = new IIS.Proba19.DetailArrayOfТЧРегРезульт(this);
                }
                IIS.Proba19.DetailArrayOfТЧРегРезульт result = this.fТЧРегРезульт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегРезультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегРезультE", typeof(IIS.Proba19.РегРезульт));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегРезультL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегРезультL", typeof(IIS.Proba19.РегРезульт));
                }
            }
        }
    }
