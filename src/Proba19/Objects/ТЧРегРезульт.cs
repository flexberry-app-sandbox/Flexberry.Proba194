...
namespace IIS.Proba19
{
    ...
    public class ТЧРегРезульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba19.ИтогСобес fИтогСобес;
        
        private int fОценкаКандид;
        
        private string fКрКомИлиОбсРеш;
        
        private IIS.Proba19.Сотрудники fСотрудники;
        
        private IIS.Proba19.РегРезульт fРегРезульт;
        ...
        public virtual IIS.Proba19.ИтогСобес ИтогСобес
        {
            get
            {
                ...
                IIS.Proba19.ИтогСобес result = this.fИтогСобес;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.Proba19.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.Proba19.Сотрудники result = this.fСотрудники;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Proba19.РегРезульт.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РегРезульт"})]
        public virtual IIS.Proba19.РегРезульт РегРезульт
        {
            get
            {
                ...
                IIS.Proba19.РегРезульт result = this.fРегРезульт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧРегРезультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧРегРезультE", typeof(IIS.Proba19.ТЧРегРезульт));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧРегРезульт : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Proba19.DetailArrayOfТЧРегРезульт members)

        // *** End programmer edit section *** (IIS.Proba19.DetailArrayOfТЧРегРезульт members)
        ...
        /// </summary>
        public DetailArrayOfТЧРегРезульт(IIS.Proba19.РегРезульт fРегРезульт) : 
                base(typeof(ТЧРегРезульт), ((ICSSoft.STORMNET.DataObject)(fРегРезульт)))
        {
        }
        
        public IIS.Proba19.ТЧРегРезульт this[int index]
        {
            get
            {
                return ((IIS.Proba19.ТЧРегРезульт)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Proba19.ТЧРегРезульт dataobject)
        {
