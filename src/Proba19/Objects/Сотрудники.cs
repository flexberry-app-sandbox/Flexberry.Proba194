...
namespace IIS.Proba19
{
    ...
    public class Сотрудники : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba19.ДолжнСотр fДолжнСотр;
        ...
        [PropertyStorage(new string[] {
                "ДолжнСотр"})]
        [NotNull()]
        public virtual IIS.Proba19.ДолжнСотр ДолжнСотр
        {
            get
            {
                ...
                IIS.Proba19.ДолжнСотр result = this.fДолжнСотр;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиE", typeof(IIS.Proba19.Сотрудники));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиL", typeof(IIS.Proba19.Сотрудники));
                }
            }
        }
    }
