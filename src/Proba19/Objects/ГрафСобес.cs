...
namespace IIS.Proba19
{
    ...
    [AssociatedDetailViewAttribute("ГрафСобесE", "ТЧГрафСобес", "ТЧГрафСобесE", true, "", "График собеседований", true, new string[] {
            ""})]
    [View("ГрафСобесL", new string[0])]
    public class ГрафСобес : ICSSoft.STORMNET.DataObject
    {
        
        private IIS.Proba19.DetailArrayOfТЧГрафСобес fТЧГрафСобес;
        ...
        public virtual IIS.Proba19.DetailArrayOfТЧГрафСобес ТЧГрафСобес
        {
            get
            {
                ...
                {
                    this.fТЧГрафСобес = new IIS.Proba19.DetailArrayOfТЧГрафСобес(this);
                }
                IIS.Proba19.DetailArrayOfТЧГрафСобес result = this.fТЧГрафСобес;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ГрафСобесE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГрафСобесE", typeof(IIS.Proba19.ГрафСобес));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ГрафСобесL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГрафСобесL", typeof(IIS.Proba19.ГрафСобес));
                }
            }
        }
    }
