  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('ГрафСобесE', 'i-i-s-proba19-граф-собес', {
      тЧГрафСобес: (0, _attributes.hasMany)('i-i-s-proba19-т-ч-граф-собес', 'График собеседований', {
        планирСобес: (0, _attributes.belongsTo)('i-i-s-proba19-планир-собес', 'ФИО', {
          регистАнкеты: (0, _attributes.belongsTo)('i-i-s-proba19-регист-анкеты', '', {
            фИОКандидата: (0, _attributes.attr)('ФИО', { index: 0 }),
            вакантДолжн: (0, _attributes.belongsTo)('i-i-s-proba19-вакант-должн', '', {
              должности: (0, _attributes.attr)('Вакантная должность', { index: 1 })
            }, { index: -1, hidden: true })
          }, { index: -1, hidden: true }),
          иметьПриСебе: (0, _attributes.attr)('Иметь при себе', { index: 3, hidden: true }),
          датаПланСобес: (0, _attributes.attr)('Дата Планир Соб', { index: 4 })
        }, { index: 2 })
      })
    });
